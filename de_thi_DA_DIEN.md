...
#### Nội dung:
> Mô tả câu hỏi use more time punctual don’t have the time you need use time badly last too long Match each expression to its meaning. 1. waste time [use time badly] 2. take a long time [last too long] 3. spend more time [use more time] 4. on time [punctual] 5. don’t have enough time [don’t have the time you need]

#### Đáp án:
> [[use time badly]] [[last too long]] [[use more time]] [[punctual]] [[don’t have the time you need]]
...
- [x] c. We cannot return your $6 deposit if you lose your locker key.
...
- [x] d. Anyone having problems with their homework may have extra time to complete it.
...
#### Đáp án:
- [x] a. Juan will sell Maria his guitar if she wants it.
...
- [x] b. Change its opening hours next Friday.
...
#### Đáp án:
- [x] a. Don’t sit at the front of the café unless you’re attending the party.
...
- [x] c. Students are not allowed on the bus unless they have ID cards.
...
- [x] d. Laura wants to try to get the same jumper in a different colour.
...
- [x] c. To ask Becky to tidy the house before she leaves
